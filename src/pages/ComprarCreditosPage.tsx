      ...
      <div className="flex-1 overflow-y-auto">
        <div className="container max-w-6xl mx-auto px-3 sm:px-4 py-4 sm:py-6 space-y-4 sm:space-y-6">
          ...
          <div className="max-w-5xl mx-auto mb-8">
            <Card className="relative bg-gradient-to-br from-primary/20 to-primary/5 border-primary border-2 shadow-2xl shadow-primary/30 overflow-hidden transform scale-105">
              <CardHeader className="pt-8 pb-4 text-center">
                ...
                <div className="flex items-center justify-center gap-3 mb-4">
                  <Badge className="bg-red-600 text-white px-3 py-2 text-base font-bold">
                    50% OFF
                  </Badge>
                ...
                <CardDescription className="text-white text-3xl lg:text-4xl font-bold flex items-center justify-center gap-4">
                  ...
                  <span className="text-primary">R$ 37,90/mês</span>
                </CardDescription>
              </CardHeader>
              <CardContent className="px-6 sm:px-8 pb-8">
                <div className="grid sm:grid-cols-2 gap-6 sm:gap-8">
                  <div className="space-y-3">
                    <div className="flex items-center gap-3 text-base">
                      ...
                      <span className="font-medium">30.000 tokens por mês</span>
                    </div>
                    <div className="flex items-center gap-3 text-base">
                      <Check className="w-5 h-5 text-primary flex-shrink-0" />
                    ...
                    <div className="flex items-center gap-3 text-base">
                      <Check className="w-5 h-5 text-primary flex-shrink-0" />
                      <span className="font-medium text-primary">7 dias grátis: 15.000 tokens no período de teste</span>
                    </div>
                  </div>
                  <div className="flex flex-col items-center justify-center gap-4">
                    <Button onClick={handleSubscribe} disabled={subLoading} className="w-full sm:w-auto h-14 px-8 text-lg font-semibold">
                      {subLoading ? (
                    ...
                    <Button onClick={handleManageSubscription} disabled={portalLoading} variant="secondary" className="w-full sm:w-auto h-12">
                      {portalLoading ? (
                        <div className="flex items-center gap-2">
                ...
                <div className="text-center mt-6 text-base text-muted-foreground bg-slate-800/30 rounded-lg p-4">
          ...
          <div className="max-w-4xl mx-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-4 lg:gap-6">
              {/* Plano Básico */}
              <Card className={`relative bg-slate-800 border-slate-700 transition-all duration-300 h-fit border-blue-500 shadow-lg shadow-blue-500/20 ${!canPurchaseTokens ? 'opacity-60' : ''}`}>
              ...
              {/* Plano Premium */}
              <Card className={`relative bg-slate-800 border-slate-700 transition-all duration-300 h-fit ${!canPurchaseTokens ? 'opacity-60' : ''}`}>
                <div className="absolute -top-2 left-1/2 -translate-x-1/2">
                ...
                <CardHeader className="text-center pt-4 sm:pt-6 pb-2 sm:pb-3">
                  <CardTitle className="text-base sm:text-lg lg:text-xl font-bold text-green-400">
                    Plano Premium
                  </CardTitle>
                  <CardDescription className="text-lg sm:text-xl lg:text-2xl font-bold text-white">
                    150.000 tokens
                ...
                <CardContent className="space-y-3 sm:space-y-4 px-3 sm:px-6 pb-4 sm:pb-6">
                  <div className="text-center">
                    <div className="flex items-center justify-center gap-2 mb-1 sm:mb-2">
                      <span className="line-through text-sm text-muted-foreground">R$ 120,00</span>
                      <span className="text-xl sm:text-2xl lg:text-3xl font-bold text-green-400">
                        R$ 97,00
                      </span>
                    </div>
                    <p className="text-xs text-muted-foreground">
                      R$ 0,647 por 1k tokens
                    </p>
                  </div>
